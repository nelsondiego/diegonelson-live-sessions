          ...
          <div className="mt-16">
            ...
            <div className="mt-4 flex justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm text-white/80 hover:text-white bg-slate-800/50 hover:bg-slate-800/70 rounded-full transition-all duration-300 border border-white/10 hover:border-neon-cyan/30"
              >
                <svg
                  className="w-4 h-4"
                  viewBox="0 0 24 24"
